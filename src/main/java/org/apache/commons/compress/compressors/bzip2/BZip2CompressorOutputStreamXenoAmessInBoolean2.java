 ...
 * @NotThreadSafe
 */
public class BZip2CompressorOutputStreamXenoAmessInBoolean2 extends CompressorOutputStream
        implements BZip2Constants {
    private static final int SEG = 0B1111;
    private static final int PIN8 = 0B1111_1111;
    private static final int PIN8_11 = PIN8;
    private static final int PIN8_10 = 0B1010_1010;
    private static final int PIN16 = 0B1111_1111_1111_1111;
    private static final int PIN16_11 = PIN16;
    private static final int PIN16_10 = 0B1010_1010_1010_1010;
    /**
     ...
     */
    public BZip2CompressorOutputStreamXenoAmessInBoolean2(final OutputStream out)
            throws IOException {
     ...
     * @see #MAX_BLOCKSIZE
     */
    public BZip2CompressorOutputStreamXenoAmessInBoolean2(final OutputStream out, final int blockSize) throws IOException {
        if (blockSize < 1) {
...
//    }
    ...
    private void need32() throws IOException {
        if (this.bsLive >= 32) {
            write32();
        } else {
            need24();
    ...
    private void need24() throws IOException {
        if (this.bsLive >= 24) {
            write24();
        } else {
            need16();
    ...
    private void need16() throws IOException {
        if (this.bsLive >= 16) {
            write16();
        } else {
            need8();
    ...
    private void need8() throws IOException {
        if (this.bsLive >= 8) {
            write8();
        }
    }
    ...
    private void push_n(final int n, final int v) throws IOException {
