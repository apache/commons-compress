...
public class BitInputStream implements Closeable {
    ...
    /**
     * Constructs a {@code BitInputStream} that reads individual bits from the given {@link InputStream}, interpreting them according to the specified bit
     * ordering.
     * <p>
     ...
     * <p>
     * Bits are read from the high (bit&nbsp;7) to the low (bit&nbsp;0) position of each byte.
     * </p>
     *
     * <pre>{@code
     *         byte 0                     byte 1
     ...
     * <p>
     * Bits are read from the low (bit&nbsp;0) to the high (bit&nbsp;7) position of each byte.
     * </p>
     *
     * <pre>{@code
     *         byte 0                     byte 1
     ...
     * @param byteOrder determines whether bits are read MSB-first ({@link ByteOrder#BIG_ENDIAN}) or LSB-first ({@link ByteOrder#LITTLE_ENDIAN}).
     */
