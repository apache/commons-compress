...
/**
 * Base class for replacements for <code>java.util.ZipFile</code>, which
 * allow the use of a custom {@link RandomAccessStream}, which does not
...
public abstract class ZipArchiveRandomAccessStream implements Closeable {
     ...
     */
    private final RandomAccessStream archive;
     ...
     */
    public ZipArchiveRandomAccessStream(String archiveName, RandomAccessStream archive, String encoding, boolean useUnicodeExtraFields)
        throws IOException {
     ...
     */
    public static void closeQuietly(ZipArchiveRandomAccessStream zipfile) {
