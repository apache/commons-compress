 ...
 * </pre>
 *
 * <b>See the section describing the Strong Encryption Specification 
 ...
 * @NotThreadSafe
 */
public class X0019_EncryptionRecipientCertificateList implements ZipExtraField {
    ...
    public void parseFromLocalFileData(byte[] data, int offset, int length) {
        System.out.println("Field: 0x0019");
