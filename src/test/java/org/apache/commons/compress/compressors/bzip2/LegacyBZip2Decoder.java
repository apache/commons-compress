...
/**
 * Verbatim copy of {@code BZip2CompressorInputStream} as of commit f8106cd28 (before the performance rewrite), used as a differential
 * oracle by {@code BZip2DifferentialTest}. Do not modify.
 *
 * @NotThreadSafe
 */
final class LegacyBZip2Decoder extends CompressorInputStream implements BZip2Constants, InputStreamStatistics {
     ...
     */
    private LegacyBZip2Decoder.Data data;

    /**
     * Constructs a new LegacyBZip2Decoder which decompresses bytes read from the specified stream. This doesn't support decompressing concatenated .bz2
     * files.
     *
    ...
    /**
     * Constructs a new LegacyBZip2Decoder which decompresses bytes read from the specified stream.
     *
     * @param in                     The InputStream from which this object should be created.
