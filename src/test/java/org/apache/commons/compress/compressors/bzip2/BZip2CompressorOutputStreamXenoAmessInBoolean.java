 ...
 * @NotThreadSafe
 */
public class BZip2CompressorOutputStreamXenoAmessInBoolean extends CompressorOutputStream
     ...
     */
    public BZip2CompressorOutputStreamXenoAmessInBoolean(final OutputStream out)
            throws IOException {
     ...
     * @see #MAX_BLOCKSIZE
     */
    public BZip2CompressorOutputStreamXenoAmessInBoolean(final OutputStream out, final int blockSize) throws IOException {
        if (blockSize < 1) {
        ...
        for (int t = 0; t < nGroups; t++) {
            ...
            for (int i = 0; i < alphaSize; i++) {
                ...
                if (curr < lti) {
                    ...
                    while (curr < lti8) {
                        bsBuffShadow |= PIN16_10 << (32 - bsLiveShadow - 16);
                    ...
                    if (curr < lti - 4) {
                        bsBuffShadow |= PIN8_10 << (32 - bsLiveShadow - 8);
                    ...
                    final int lti8 = lti + 8;
                    while (curr > lti8) {
                        bsBuffShadow |= PIN16_11 << (32 - bsLiveShadow - 16);
                    ...
                    if (curr > lti + 4) {
                        bsBuffShadow |= PIN8_11 << (32 - bsLiveShadow - 8);
