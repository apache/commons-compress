...
public class GnuTarHeader extends AbstractTarHeader {
    public GnuTarHeader(String fileName, long fileSize, long lastModifiedTime, byte linkIndicator, String linkName) {
        super(fileName, fileSize, lastModifiedTime, linkIndicator, linkName, GNU_MAGIC_AND_VERSION);
    }
