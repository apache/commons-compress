...
/**
 * Run this test: mvn clean test -Pbenchmark -Dbenchmark=Lh5CompressorInputStreamBenchmark
 */
...
public class Lh5CompressorInputStreamBenchmark {
    ...
    public static class DecompressionState {
        ...
        public void setup() throws IOException {
            final byte[] archiveData = AbstractTest.readAllBytes("test-macos-l0-lh5.lha");
            compressedData = Arrays.copyOfRange(archiveData, 0x33, 0x33 + 0x9c3f);

            try (InputStream is = LhStaticHuffmanCompressorInputStream.lh5CompressorInputStream(
