...
class CPStringTest {
    ...
    void testEqualsEdgeCases() {
        ...
        final CPString maxValue = new CPString(new CPUTF8("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"));
        assertEquals(zero, new CPString(new CPUTF8("0")));
        assertEquals(minValue, new CPString(new CPUTF8("")));
        assertEquals(maxValue, new CPString(new CPUTF8("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz")));
