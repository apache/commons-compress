...
class CPClassTest {
    ...
    void testEqualsEdgeCases() {
        ...
        final CPClass maxValue = new CPClass(new CPUTF8("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"));
        assertEquals(zero, new CPClass(new CPUTF8("0")));
        assertEquals(minValue, new CPClass(new CPUTF8("")));
        assertEquals(maxValue, new CPClass(new CPUTF8("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz")));
